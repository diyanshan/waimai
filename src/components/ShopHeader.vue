<template>
    <div class="shop-header">
      ...
      <div class="shop-content" @click="nameIsShow = true">
      ...
      <div class="shop-header-discounts" v-if="info.name" @click="listIsShow =true">
        <div class="discounts-left">
          <div class="activity" :class="classes[info.supports[0].type]">
          <span class="content-tag">
      ...
      <transition name="fade">
        <div class="shop-brief-modal" v-show="nameIsShow">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer"  @click="nameIsShow = false">
      ...
      <div class="activity-sheet"  v-if="listIsShow">
          <div class="activity-sheet-content">
            <h2 class="activity-sheet-title">优惠活动</h2>
            <ul class="list">
              <li class="activity-item" :class="classes[support.type]" v-for="(support, index) in info.supports" :key="index">
            <span class="content-tag">
            ...
            <div class="activity-sheet-close" @click="listIsShow = false">
              <span class="iconfont icon-close"></span>
            </div>
          </div>
