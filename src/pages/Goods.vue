  ...
  <div>
    <div class="goods">
      <div class="menu-wrapper" >
        <ul ref="leftUi">
          <li class="menu-item" :class="{current: currentIndex === index}" v-for="(good, index) in goods" :key="index" @click="clickLeftItem(index)">
...
<script>
  ...
  export default {
    ...
    methods:{
          ...
          _initTops(){
          //  findIndex  查找ul下子元素的下标
          //  forEach    遍历ul下所有的元素节点
          //  slice 将类数组转化成新数组
            const tops =[]
            let top = 0
            tops.push(top)
